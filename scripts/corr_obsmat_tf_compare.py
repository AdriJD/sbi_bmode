...
with open('/u/bing/sbi_bmode/scripts/configs/config_corr_tf_2.yaml') as f:
...
figdir = "/ptmp/bing/sbi_bmode_storage/figures/corr_obsmat_tf_4"
...
plt.savefig(f"{figdir}/cov_tf.png", bbox_inches="tight", dpi=300)
plt.close()
...
plt.savefig(f"{figdir}/cov_obsmat.png", bbox_inches="tight", dpi=300)
plt.close()
...
plt.savefig(f"{figdir}/corr_tf.png", bbox_inches="tight", dpi=300)
plt.close()
...
plt.savefig(f"{figdir}/corr_obsmat.png", bbox_inches="tight", dpi=300)
plt.close()