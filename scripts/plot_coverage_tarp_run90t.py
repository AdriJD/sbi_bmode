...
tarpdir = opj(basedir, 'tarp90t_b')
tarpdir1 = opj(basedir, 'tarp90t_tf_b')
...
ax.plot(
    ...
    lw=1,
    linestyle=':',
    label='Joint TARP (Transfer function)'
)
...
ax.set_title("TARP ObsMat training sets")
